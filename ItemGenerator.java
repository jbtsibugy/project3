...
class ItemGenerator {
	...
	list.add(w4);
	Item w5 = new Item(ItemType.WEAPON, "Machine Gun", 14, 35, 45);
	list.add(w5);
	Item w6 = new Item(ItemType.WEAPON, "Combat Knife", 1, 5, 3);
	list.add(w6);
	Item w7 = new Item(ItemType.WEAPON, "Flamethrower", 20, 20, 25);
	list.add(w7);
	Item a1 = new Item(ItemType.ARMOR, "Flack Jacket", 6, 16, 15);
	list.add(a1);
	Item a2 = new Item(ItemType.ARMOR, "Heavy Body Armor", 15, 25, 30);
	list.add(a2);
	Item a3 = new Item(ItemType.ARMOR, "Military Armor", 10, 30, 35);
	list.add(a3);
	Item a4 = new Item(ItemType.ARMOR, "Military Armor w/ Helmet", 12, 35, 40);
	list.add(a4);
	Item a5 = new Item(ItemType.ARMOR, "Small Shield", 4, 8, 10);
	list.add(a5);
	Item a6 = new Item(ItemType.ARMOR, "Large Shield", 10, 16, 20);
	list.add(a6);
